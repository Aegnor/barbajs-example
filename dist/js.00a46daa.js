...
},{"./gsap-core.js":"../node_modules/gsap/gsap-core.js","./CSSPlugin.js":"../node_modules/gsap/CSSPlugin.js"}],"../node_modules/process/browser.js":[function(require,module,exports) {
...
},{"process":"../node_modules/process/browser.js"}],"js/utils/dom.js":[function(require,module,exports) {
"use strict";
...
},{"core-js/shim":"../node_modules/core-js/shim.js","regenerator-runtime/runtime":"../node_modules/babel-polyfill/node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"../node_modules/core-js/fn/regexp/escape.js"}],"bg-1.jpg":[function(require,module,exports) {
...
function PJAXPrepare() {
  _gsap.default.timeline().set(preloader, {
    opacity: 1,
    visibility: 'visible'
  });

  _gsap.default.timeline().set(preloaderInner, {
    scaleX: 0,
...
function PJAXCalcPositionTop() {
  return (0, _jquery.default)('.shit').get(0).getBoundingClientRect().top;
}

function CloneImage(data, selector) {
  var target = (0, _jquery.default)(data.trigger),
  ...
  _gsap.default.timeline().set(clone, {
    position: 'fixed',
    top: 0,
    left: 0,
    x: imgPosition.left,
...
var PJAXTransitionBlock = {
  ...
  custom: function custom(_ref) {
    ...
    return (0, _jquery.default)(trigger).data('pjax-link') == 'simple';
  },
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              _gsap.default.timeline().to(preloaderInner, {
                scaleX: 1,
                transformOrigin: 'left center',
                ease: 'Expo.easeInOut'
              });
...
var PJAXTransitionImage = {
  name: 'image',
  custom: function custom(_ref2) {
    var current = _ref2.current,
        next = _ref2.next,
        trigger = _ref2.trigger;
    return (0, _jquery.default)(trigger).data('pjax-link') == 'image';
  },
  leave: function leave(data) {
    var _this2 = this;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 3;
              return CloneImage(data);

            case 3:
              console.log('shit anim');
              clone = (0, _jquery.default)('.is-clone');

              _gsap.default.timeline().to(clone, {
                x: 0,
                y: 0,
                width: '100%',
                height: '100%',
      ...
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              return _context3.abrupt("return", PJAXinitPage());
...
function PJAXAnimateNewImg(data) {
  var nextContainer = (0, _jquery.default)(data.next.container),
      clone = (0, _jquery.default)('.is-clone'),
...
var PJAX = function PJAX() {
  _core.default.init({
    sync: true,
    transitions: [PJAXTransitionBlock, PJAXTransitionImage]
  });
};

new PJAX();
},{"@barba/core":"../node_modules/@barba/core/dist/barba.umd.js","gsap":"../node_modules/gsap/index.js","jquery":"../node_modules/jquery/dist/jquery.js","./utils/dom":"js/utils/dom.js","babel-polyfill":"../node_modules/babel-polyfill/lib/index.js","../bg-1.jpg":"bg-1.jpg","../bg-4.jpg":"bg-4.jpg"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "24547" + '/');
